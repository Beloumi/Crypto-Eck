...
/*
 * Password Hashing Scheme Catena (v3)
...
public abstract class Catena_v3_2 implements PasswordHashingScheme {
...
//	private static final int PROOF_OF_WORK_MODE = 2;
	 ...
	 */
	public Catena_v3_2(boolean fast) {
		setFast(fast);
	}
	 ...
	 * 						as possible
	 */
	public Catena_v3_2(boolean fast, boolean overwrite) {
		setFast(fast);
	...
	protected void hashFast(int vIndex, 
		...
		if (fast == true) {
			//ReducedDigest fastHash = (ReducedDigest) fastDigest;
